function createActivityCard(activity) {
  ...
  card.innerHTML = `
    <div class="icon-box">
      ...
      <a class="booking-btn" data-toggle="modal" data-target="#bookingModal" data-activity-name="${activity.name}" data-activity-id="${activity.id}" data-activity-minAge="${activity.minAge}">Book</a>
    </div>
  `;
